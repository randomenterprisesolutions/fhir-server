 ...
 */
package com.randomenterprisesolutions.fhir.audit.configuration;

import static com.randomenterprisesolutions.fhir.audit.AuditLogServiceConstants.DEFAULT_AUDIT_KAFKA_TOPIC;
import static com.randomenterprisesolutions.fhir.audit.AuditLogServiceConstants.DEFAULT_MAPPER;
import static com.randomenterprisesolutions.fhir.audit.AuditLogServiceConstants.FIELD_LOAD;
import static com.randomenterprisesolutions.fhir.audit.AuditLogServiceConstants.KAFKA_USERNAME;
import static com.randomenterprisesolutions.fhir.audit.AuditLogServiceConstants.PROPERTY_AUDIT_KAFKA_APIKEY;
import static com.randomenterprisesolutions.fhir.audit.AuditLogServiceConstants.PROPERTY_AUDIT_KAFKA_BOOTSTRAPSERVERS;
import static com.randomenterprisesolutions.fhir.audit.AuditLogServiceConstants.PROPERTY_AUDIT_KAFKA_TOPIC;
import static com.randomenterprisesolutions.fhir.audit.AuditLogServiceConstants.PROPERTY_AUDIT_MAPPER;
import static com.randomenterprisesolutions.fhir.audit.configuration.type.KafkaType.KAFKA_BOOTSTRAP_SERVERS;
import static com.randomenterprisesolutions.fhir.audit.configuration.type.KafkaType.KAFKA_DEFAULT_SASL_MECHANISM;
import static com.randomenterprisesolutions.fhir.audit.configuration.type.KafkaType.KAFKA_DEFAULT_SECURITY_PROTOCOL;
import static com.randomenterprisesolutions.fhir.audit.configuration.type.KafkaType.KAFKA_DEFAULT_SERIALIZER;
import static com.randomenterprisesolutions.fhir.audit.configuration.type.KafkaType.KAFKA_DEFAULT_SSL_ENDPOINT_IDENTIFICATION_ALGORITHM;
import static com.randomenterprisesolutions.fhir.audit.configuration.type.KafkaType.KAFKA_DEFAULT_SSL_PROTOCOL;
import static com.randomenterprisesolutions.fhir.audit.configuration.type.KafkaType.KAFKA_KEY_SERIALIZER;
import static com.randomenterprisesolutions.fhir.audit.configuration.type.KafkaType.KAFKA_SASL_JAAS_CONFIG;
import static com.randomenterprisesolutions.fhir.audit.configuration.type.KafkaType.KAFKA_SASL_MECHANISM;
import static com.randomenterprisesolutions.fhir.audit.configuration.type.KafkaType.KAFKA_SECURITY_PROTOCOL;
import static com.randomenterprisesolutions.fhir.audit.configuration.type.KafkaType.KAFKA_SSL_ENABLED_PROTOCOLS;
import static com.randomenterprisesolutions.fhir.audit.configuration.type.KafkaType.KAFKA_SSL_ENDPOINT_IDENTIFICATION_ALGORITHM;
import static com.randomenterprisesolutions.fhir.audit.configuration.type.KafkaType.KAFKA_SSL_PROTOCOLS;
import static com.randomenterprisesolutions.fhir.audit.configuration.type.KafkaType.KAFKA_VALUE_SERIALIZER;
...
import com.randomenterprisesolutions.fhir.audit.configuration.type.IBMEventStreamsType;
import com.randomenterprisesolutions.fhir.audit.configuration.type.KafkaType;
import com.randomenterprisesolutions.fhir.audit.mapper.MapperType;
...
public class ConfigurationTranslator {
    ...
    private static Map<String, String> generateMap() {
        ...
        mapped.put("com.randomenterprisesolutions.fhir.audit.logging.impl.DisabledAuditLogService", "com.randomenterprisesolutions.fhir.audit.impl.NopService");
        mapped.put("com.randomenterprisesolutions.fhir.audit.logging.impl.WhcAuditCadfLogService", "com.randomenterprisesolutions.fhir.audit.impl.KafkaService");
        return mapped;
    }
    ...
    public void environment(Properties props, PropertyGroup auditLogProperties) throws Exception {
        ...
        if (System.getenv(IBMEventStreamsType.KUB_BINDING) != null) {
            ...
            com.randomenterprisesolutions.fhir.audit.configuration.type.IBMEventStreamsType.EventStreamsCredentials credentials = IBMEventStreamsType.getEventStreamsCredentials();
            if (credentials != null) {
