 ...
 */
package com.randomenterprisesolutions.fhir.audit.mapper.impl;
...
import com.randomenterprisesolutions.fhir.audit.AuditLogEventType;
import com.randomenterprisesolutions.fhir.audit.beans.AuditLogEntry;
import com.randomenterprisesolutions.fhir.audit.beans.FHIRContext;
import com.randomenterprisesolutions.fhir.audit.mapper.Mapper;
...
import com.randomenterprisesolutions.fhir.model.resource.AuditEvent.Agent;
import com.randomenterprisesolutions.fhir.model.resource.AuditEvent.Agent.Network;
import com.randomenterprisesolutions.fhir.model.resource.AuditEvent.Entity;
import com.randomenterprisesolutions.fhir.model.resource.AuditEvent.Entity.Detail;
import com.randomenterprisesolutions.fhir.model.resource.AuditEvent.Source;
...
import com.randomenterprisesolutions.fhir.model.type.code.AuditEventAction;
import com.randomenterprisesolutions.fhir.model.type.code.AuditEventAgentNetworkType;
...
public class AuditEventMapper implements Mapper {
    ...
    private static Map<String, com.randomenterprisesolutions.fhir.model.type.code.AuditEventAction> buildMapToAction() {
        Map<String, com.randomenterprisesolutions.fhir.model.type.code.AuditEventAction> map = new HashMap<>();
     ...
     */
    private com.randomenterprisesolutions.fhir.model.type.Period period(AuditLogEntry entry) {
        // @formatter:off
        return com.randomenterprisesolutions.fhir.model.type.Period.builder()
                .start(com.randomenterprisesolutions.fhir.model.type.DateTime.of(
                    ZonedDateTime.of(Timestamp.valueOf(entry.getContext().getStartTime()).toLocalDateTime(), ZoneId.of("UTC"))
                    ))
                .end(com.randomenterprisesolutions.fhir.model.type.DateTime.of(
    ...
    private List<Agent> agent(AuditLogEntry entry) {
        Agent collector = Agent.builder()
                .requestor(com.randomenterprisesolutions.fhir.model.type.Boolean.TRUE)
     ...
     */
    private com.randomenterprisesolutions.fhir.model.type.String outcomeDesc(AuditLogEntry entry) {
    ...
    private com.randomenterprisesolutions.fhir.model.type.code.AuditEventOutcome outcome(AuditLogEntry entry) {
        if (entry.getContext().getApiParameters().getStatus() < 400) {
            return com.randomenterprisesolutions.fhir.model.type.code.AuditEventOutcome.OUTCOME_0;
        } else if (entry.getContext().getApiParameters().getStatus() < 500) {
            return com.randomenterprisesolutions.fhir.model.type.code.AuditEventOutcome.OUTCOME_4;
        } else {
            return com.randomenterprisesolutions.fhir.model.type.code.AuditEventOutcome.OUTCOME_12;
        }
    }
}