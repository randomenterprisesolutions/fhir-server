...
package com.randomenterprisesolutions.fhir.client.impl;
...
public class FHIRResponseImpl implements FHIRResponse {
    ...
    /* (non-Javadoc)
     * @see com.randomenterprisesolutions.fhir.client.FHIRResponse#getStatusCode()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.randomenterprisesolutions.fhir.client.FHIRResponse#getLocationURI()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.randomenterprisesolutions.fhir.client.FHIRResponse#getLocation()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.randomenterprisesolutions.fhir.client.FHIRResponse#getLastModified()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.randomenterprisesolutions.fhir.client.FHIRResponse#getETag()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.randomenterprisesolutions.fhir.client.FHIRResponse#getResource(java.lang.Class)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.randomenterprisesolutions.fhir.client.FHIRResponse#getResponse()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.randomenterprisesolutions.fhir.client.FHIRResponse#parseLocation()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.randomenterprisesolutions.fhir.client.FHIRResponse#isEmpty()
     */
    @Override
