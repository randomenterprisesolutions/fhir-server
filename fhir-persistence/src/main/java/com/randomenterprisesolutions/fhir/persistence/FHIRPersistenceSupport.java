...
public class FHIRPersistenceSupport {
     ...
     */
    public static com.randomenterprisesolutions.fhir.model.type.Instant getCurrentInstant() {
    ...
    public static Instant getLastUpdatedFromResource(Resource resource) {
        ...
        com.randomenterprisesolutions.fhir.model.type.Instant lastUpdated = resource.getMeta().getLastUpdated();
     ...
     * @return
     */
    public static com.randomenterprisesolutions.fhir.model.type.Instant getNewLastUpdatedInstant(Instant currentLastUpdated) throws FHIRPersistenceException {
        ...
        return com.randomenterprisesolutions.fhir.model.type.Instant.of(lastUpdated.atZone(ZoneOffset.UTC));
    }
}