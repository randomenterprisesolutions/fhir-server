...
import com.randomenterprisesolutions.fhir.model.resource.Resource.Builder;
...
public class FHIRPersistenceUtil {
     ...
     * @return
     */
    public static com.randomenterprisesolutions.fhir.model.type.Instant getUpdateTime() {
        return com.randomenterprisesolutions.fhir.model.type.Instant.now(ZoneOffset.UTC);
    }
    ...
    public static <T extends Resource> T copyAndSetResourceMetaFields(T resource, String logicalId, int newVersionNumber, com.randomenterprisesolutions.fhir.model.type.Instant lastUpdated) {
