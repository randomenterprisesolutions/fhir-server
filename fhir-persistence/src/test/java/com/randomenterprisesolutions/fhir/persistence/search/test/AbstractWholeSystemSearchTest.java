...
public abstract class AbstractWholeSystemSearchTest extends AbstractPLSearchTest {
    ...
    // v3-ActReason is a "polyhierarchy" codesystem; we need https://github.com/randomenterprisesolutions/FHIR/issues/3448 for that one
    ...
    public Basic getBasicResource() throws Exception {
        ...
        Coding tag3 =
                Coding.builder()
                        ...
                        .code(Code.of(TAG4))
                        .display(com.randomenterprisesolutions.fhir.model.type.String.of(TAG4TEXT))
                        .build();
        ...
        return basic.toBuilder()
                .meta(meta)
                .author(Reference.builder().reference(com.randomenterprisesolutions.fhir.model.type.String.of(AUTHOR)).build())
                .build();
    }
