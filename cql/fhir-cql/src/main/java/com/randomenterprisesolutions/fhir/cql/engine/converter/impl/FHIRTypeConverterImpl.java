 ...
 */
package com.randomenterprisesolutions.fhir.cql.engine.converter.impl;

import static com.randomenterprisesolutions.fhir.cql.helpers.ModelHelper.fhirstring;
import static com.randomenterprisesolutions.fhir.cql.helpers.ModelHelper.fhiruri;
...
import com.randomenterprisesolutions.fhir.cql.engine.converter.FHIRTypeConverter;
import com.randomenterprisesolutions.fhir.cql.helpers.DateHelper;
...
public class FHIRTypeConverterImpl implements FHIRTypeConverter {
    ...
    public com.randomenterprisesolutions.fhir.model.type.Boolean toFhirBoolean(Boolean value) {
        com.randomenterprisesolutions.fhir.model.type.Boolean result = null;
        if (value != null) {
            result = com.randomenterprisesolutions.fhir.model.type.Boolean.of(value);
        }
        return result;
    }
    ...
    public Integer toFhirInteger(java.lang.Integer value) {
        com.randomenterprisesolutions.fhir.model.type.Integer result = null;
        if (value != null) {
            result = com.randomenterprisesolutions.fhir.model.type.Integer.of(value);
        }
        return result;
    }
    ...
    public com.randomenterprisesolutions.fhir.model.type.String toFhirString(String value) {
        com.randomenterprisesolutions.fhir.model.type.String result = null;
        if (value != null) {
            result = com.randomenterprisesolutions.fhir.model.type.String.of(value);
        }
        return result;
    }
    ...
    public Object toCqlType(Object value) {
        ...
        case "Id":
            ...
            break;
        case "Boolean":
            result = toCqlBoolean((com.randomenterprisesolutions.fhir.model.type.Boolean) value);
            break;
        case "Integer":
            result = toCqlInteger((com.randomenterprisesolutions.fhir.model.type.Integer) value);
            break;
        case "Decimal":
            result = toCqlDecimal((com.randomenterprisesolutions.fhir.model.type.Decimal) value);
            break;
        case "Date":
            result = toCqlDate((com.randomenterprisesolutions.fhir.model.type.Date) value);
            break;
        // NOTE: There's no first class InstantType in CQL, so the conversation to CQL
        // DateTime and back is asymmetric
        case "Instant":
        case "DateTime":
            result = toCqlDateTime((com.randomenterprisesolutions.fhir.model.type.DateTime) value);
            break;
        case "Time":
            result = toCqlTime((com.randomenterprisesolutions.fhir.model.type.Time) value);
            break;
        case "String":
            result = toCqlString((com.randomenterprisesolutions.fhir.model.type.String) value);
            break;
        case "Quantity":
            result = toCqlQuantity((com.randomenterprisesolutions.fhir.model.type.Quantity) value);
            break;
        case "Ratio":
            result = toCqlRatio((com.randomenterprisesolutions.fhir.model.type.Ratio) value);
            break;
        // case "AnyType": result = toCqlAny((IBase)value);break;
        case "Coding":
            result = toCqlCode((com.randomenterprisesolutions.fhir.model.type.Coding) value);
            break;
        case "CodeableConcept":
            result = toCqlConcept((com.randomenterprisesolutions.fhir.model.type.CodeableConcept) value);
            break;
        case "Period":
        case "Range":
            result = toCqlInterval((com.randomenterprisesolutions.fhir.model.type.Element) value);
            break;
