...
package com.randomenterprisesolutions.fhir.operation.apply;
...
import com.randomenterprisesolutions.fhir.model.resource.CarePlan.Activity.Detail;
...
import com.randomenterprisesolutions.fhir.model.type.Dosage.DoseAndRate;
...
public class ApplyOperation extends AbstractOperation {
    ...
    private CodeableConcept internalCheckAndProcess(FHIROperationContext operationContext,
        ...
        for (Parameter p : parameters.getParameter()) {
            if (p.getName() != null && p.getName().getValue().compareTo(parameter) == 0) {
                return p.getValue().as(com.randomenterprisesolutions.fhir.model.type.CodeableConcept.class);
            }
        }
        return null;
    }
    ...
    private String internalCheckAndProcess(FHIRResourceHelpers resourceHelper,
        ...
        if (result == null) {
            for (Parameter p : parameters.getParameter()) {
                ...
                if (p.getName() != null && p.getName().getValue().compareTo(parameter) == 0) {
                    result = p.getValue().as(com.randomenterprisesolutions.fhir.model.type.String.class).getValue();
                    break;
                }
            }
        }
    ...
    private CarePlan transform(PlanDefinition planDefinition, List<String> subjects,
        ...
        if (userTaskContext != null) {
            builder.description(userTaskContext.as(com.randomenterprisesolutions.fhir.model.type.String.class));
        }
        ...
        if (userLanguage != null) {
            com.randomenterprisesolutions.fhir.model.type.String lang = userLanguage.getText();
