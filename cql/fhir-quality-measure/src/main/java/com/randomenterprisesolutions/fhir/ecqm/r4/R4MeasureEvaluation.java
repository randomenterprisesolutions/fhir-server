 ...
 */
package com.randomenterprisesolutions.fhir.ecqm.r4;

import static com.randomenterprisesolutions.fhir.cql.helpers.ModelHelper.canonical;
import static com.randomenterprisesolutions.fhir.cql.helpers.ModelHelper.coding;
import static com.randomenterprisesolutions.fhir.cql.helpers.ModelHelper.fhirinteger;
import static com.randomenterprisesolutions.fhir.cql.helpers.ModelHelper.fhirstring;
import static com.randomenterprisesolutions.fhir.cql.helpers.ModelHelper.javastring;
...
import com.randomenterprisesolutions.fhir.ecqm.common.MeasureEvaluation;
import com.randomenterprisesolutions.fhir.ecqm.common.MeasureInfo;
import com.randomenterprisesolutions.fhir.ecqm.common.MeasurePopulationType;
import com.randomenterprisesolutions.fhir.ecqm.common.MeasureReportType;
import com.randomenterprisesolutions.fhir.ecqm.common.MeasureScoring;
...
import com.randomenterprisesolutions.fhir.model.resource.Measure.SupplementalData;
...
import com.randomenterprisesolutions.fhir.model.type.code.ListMode;
import com.randomenterprisesolutions.fhir.model.type.code.ListStatus;
import com.randomenterprisesolutions.fhir.model.type.code.MeasureReportStatus;
...
public class R4MeasureEvaluation<ST extends DomainResource> extends
        MeasureEvaluation<Object, Measure, Measure.Group, Measure.Group.Population, Measure.SupplementalData, 
            ...
            Coding, Extension, Reference.Builder, com.randomenterprisesolutions.fhir.model.resource.List, com.randomenterprisesolutions.fhir.model.resource.List.Entry,
            DomainResource, ST> {
    ...
    protected void addPopulationReport(MeasureReport.Builder report, MeasureReport.Group.Builder group,
        ...
        populationReport.count(com.randomenterprisesolutions.fhir.model.type.Integer.of(populationCount));
        ...
        if ((type == MeasureReportType.SUBJECTLIST || type == MeasureReportType.PATIENTLIST) && subjectPopulation != null) {
            com.randomenterprisesolutions.fhir.model.resource.List.Builder SUBJECTLIST = com.randomenterprisesolutions.fhir.model.resource.List.builder();
            ...
            for( ST patient : subjectPopulation ) {
                com.randomenterprisesolutions.fhir.model.resource.List.Entry.Builder entry = com.randomenterprisesolutions.fhir.model.resource.List.Entry.builder();
    ...
    protected MeasureReport.Builder createMeasureReport(String status, MeasureReportType type, Interval measurementPeriod,
        ...
        report.type(com.randomenterprisesolutions.fhir.model.type.code.MeasureReportType.of(type.toCode()));
    ...
    @Override
    protected com.randomenterprisesolutions.fhir.model.resource.List createListResource(Collection<com.randomenterprisesolutions.fhir.model.resource.List.Entry> entries) {
        return com.randomenterprisesolutions.fhir.model.resource.List.builder()
    ...
    @Override
    protected com.randomenterprisesolutions.fhir.model.resource.List.Entry createListEntry(Reference.Builder reference) {
        return com.randomenterprisesolutions.fhir.model.resource.List.Entry.builder().item(reference.build()).build();
    }
