 ...
 */
package com.randomenterprisesolutions.fhir.cql.engine.rest.terminology;

import static com.randomenterprisesolutions.fhir.cql.engine.util.FHIRClientUtil.urlencode;
...
import com.randomenterprisesolutions.fhir.cql.engine.rest.R4RestFHIRTest;
...
import com.randomenterprisesolutions.fhir.model.resource.ValueSet.Expansion;
import com.randomenterprisesolutions.fhir.model.resource.ValueSet.Expansion.Contains;
...
public class RestFHIRTerminologyProviderTest extends R4RestFHIRTest {
    ...
    public void resolveByUrlUsingIdentifierSucceeds() throws Exception {
        ...
        ValueSet response =
                ValueSet.builder().id("1.2.3.4").status(PublicationStatus.ACTIVE).identifier(Identifier.builder().value(com.randomenterprisesolutions.fhir.model.type.String.of(info.getId())).build()).build();
    ...
    public void inOperationReturnsTrueWhenFhirReturnsTrue() throws Exception {
        ...
        Parameters parameters =
                Parameters.builder().parameter(Parameters.Parameter.builder().name(com.randomenterprisesolutions.fhir.model.type.String.of("result")).value(com.randomenterprisesolutions.fhir.model.type.Boolean.of(true)).build()).build();
    ...
    public void inOperationReturnsFalseWhenFhirReturnsFalse() throws Exception {
        ...
        Parameters parameters =
                Parameters.builder().parameter(Parameters.Parameter.builder().name(com.randomenterprisesolutions.fhir.model.type.String.of("result")).value(com.randomenterprisesolutions.fhir.model.type.Boolean.of(false)).build()).build();
    ...
    public void lookupOperationSuccess() throws Exception {
        ...
        Parameters parameters =
                Parameters.builder().parameter(Parameter.builder().name(com.randomenterprisesolutions.fhir.model.type.Code.of("name")).value(com.randomenterprisesolutions.fhir.model.type.String.of(code.getCode())).build()).parameter(Parameter.builder().name(com.randomenterprisesolutions.fhir.model.type.Code.of("version")).value(code.getVersion() != null
                        ? com.randomenterprisesolutions.fhir.model.type.String.of(code.getVersion())
                        : null).build()).parameter(Parameter.builder().name(com.randomenterprisesolutions.fhir.model.type.Code.of("display")).value(code.getDisplay() != null
                                ? com.randomenterprisesolutions.fhir.model.type.String.of(code.getDisplay()) : null).build()).build();
    ...
    private ValueSet getSingleCodeValueSet(String id, String system, String code) {
        ValueSet valueSet =
                ValueSet.builder().id(id).status(PublicationStatus.ACTIVE).expansion(Expansion.builder().timestamp(DateTime.now()).contains(Contains.builder().system(Uri.of(system)).code(com.randomenterprisesolutions.fhir.model.type.Code.of(code)).build()).build()).build();
        return valueSet;
    }
}
