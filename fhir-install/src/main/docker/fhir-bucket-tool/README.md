...
The image wraps the randomenterprisesolutions FHIR Server Bucket Tool which wraps the module - `fhir-bucket`.

************
# **License**

The randomenterprisesolutions FHIR Server - Bucket Tool is licensed under the Apache 2.0 license. Full license text is available at [LICENSE](https://github.com/randomenterprisesolutions/FHIR/blob/main/LICENSE).
