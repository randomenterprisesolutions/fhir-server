...
public class CompartmentCacheTest extends BaseSearchTest {
    ...
    public void testGetParametersByResourceTypeInCompartmentUnmodifiable() {
        ...
        List<com.randomenterprisesolutions.fhir.model.type.String> params = new ArrayList<>();
        params.add(com.randomenterprisesolutions.fhir.model.type.String.string("Ketchup"));
