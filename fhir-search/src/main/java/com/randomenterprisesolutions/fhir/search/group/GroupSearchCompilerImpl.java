...
import com.randomenterprisesolutions.fhir.search.group.characteristic.AdministrativeGenderCharacteristicProcessor;
import com.randomenterprisesolutions.fhir.search.group.characteristic.CharacteristicProcessor;
import com.randomenterprisesolutions.fhir.search.group.characteristic.NoOpCharacteristicProcessor;
import com.randomenterprisesolutions.fhir.search.group.characteristic.PatientAgeCharacteristicProcessor;
import com.randomenterprisesolutions.fhir.search.group.characteristic.PregnancyStatusCharacteristicProcessor;
    ...
    public MultivaluedMap<String, String> groupToSearch(Group group, String target) throws GroupSearchCompilerException {
        ...
        try {
            ...
            for (FHIRPathNode node : tmpResults) {
                ...
                } else if (characteristic.getValue().is(com.randomenterprisesolutions.fhir.model.type.Boolean.class)) {
