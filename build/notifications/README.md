# End-to-End Automation Framework for FHIR Notifications Integration Tests
...
You must also start Docker, so the image is built that supports the randomenterprisesolutions FHIR Server.
