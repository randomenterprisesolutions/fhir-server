...
package com.randomenterprisesolutions.fhir.server.test.profiles;
...
import com.randomenterprisesolutions.fhir.model.resource.CareTeam;
...
import com.randomenterprisesolutions.fhir.server.test.profiles.ProfilesTestBase.ProfilesTestBaseV2;

/**
 * Carin for BlueButton (C4BB) Profile Integration Tests v1.1.0
 */
public class CarinBlueButtonV110Test extends ProfilesTestBaseV2 {
    ...
    public List<String> getRequiredProfiles() {
        ...
        return Arrays.asList(
            "http://hl7.org/fhir/us/carin-bb/StructureDefinition/C4BB-Coverage|1.1.0",
            "http://hl7.org/fhir/us/carin-bb/StructureDefinition/C4BB-ExplanationOfBenefit|1.1.0",
            ...
            "http://hl7.org/fhir/us/carin-bb/StructureDefinition/C4BB-ExplanationOfBenefit-Pharmacy|1.1.0",
    ...
    public void loadOrganizationOrg1() throws Exception {
        ...
        organizationOrg1Id = buildAndAssertOnResourceForC4BB("Organization", "110", resource);
    }

    public void loadOrganizationOrg45() throws Exception {
        String resource = "Organization-Payer1.json";
        organizationOrg45Id = buildAndAssertOnResourceForC4BB("Organization", "110", resource);
    }

    // Load Coverage Resources
    public void loadCoverage() throws Exception {
        String resource = "Coverage-Coverage1.json";
        Coverage coverage = C4BBExamplesUtil.readLocalJSONResource("110", resource);

        Reference org45ref = Reference.builder()
                .reference(com.randomenterprisesolutions.fhir.model.type.String.of("Organization/" + organizationOrg45Id))
                .build();
    ...
    public void loadPatient() throws Exception {
        ...
        patientId = buildAndAssertOnResourceForC4BB("Patient", "110", resource);
    }
    ...
    public void loadExplanationOfBenefitsInPatient() throws Exception {
        ...
        explanationOfBenefitInPatientId = buildAndAssertOnResourceForC4BB("ExplanationOfBenefit", "110", resource);
    }
    ...
    public void loadExplanationOfBenefitsOutPatient() throws Exception {
        ...
        explanationOfBenefitsOutPatient = buildAndAssertOnResourceForC4BB("ExplanationOfBenefit", "110", resource);
    }

    public void loadExplanationOfBenefitsPharmacy() throws Exception {
        String resource = "ExplanationOfBenefit-EOBPharmacy1.json";
        explanationOfBenefitsPharmacyId = buildAndAssertOnResourceForC4BB("ExplanationOfBenefit", "110", resource);
    }
    ...
    public void loadExplanationOfBenefitsInpatientInstitutionalEx1() throws Exception {
        String resource = "ExplanationOfBenefit-EOBInpatient1.json";
        eobInpatientInstitutionalEx1id = buildAndAssertOnResourceForC4BB("ExplanationOfBenefit", "110", resource);
    }
    ...
    public void testCARINBlueButton_ExplanationOfBenefit_Patient_SearchParameter() throws Exception {
        ...
        // https://github.com/randomenterprisesolutions/FHIR/issues/1157
        FHIRParameters parameters = new FHIRParameters();
