...
import com.randomenterprisesolutions.fhir.client.FHIRClient;
import com.randomenterprisesolutions.fhir.client.FHIRClientFactory;
...
import com.randomenterprisesolutions.fhir.server.test.websocket.FHIRNotificationServiceClientEndpoint;
...
public abstract class FHIRServerTestBase {
    ...
    protected boolean isComparmentSearchSupported() throws Exception {
        ...
        for (Extension e : conf.getExtension()) {
            if (e.getUrl().contains("persistenceType") && (((com.randomenterprisesolutions.fhir.model.type.String) e.getValue())
                    .getValue().contains("FHIRPersistenceJDBCImpl")
                    || ((com.randomenterprisesolutions.fhir.model.type.String) e.getValue()).getValue()
        ...
        if (restList != null) {
            ...
            if (rest != null) {
                ...
                if (rest.getInteraction() != null) {
                    for (com.randomenterprisesolutions.fhir.model.resource.CapabilityStatement.Rest.Interaction interaction : rest.getInteraction()) {
