...
package com.randomenterprisesolutions.fhir.server.test.terminology;
...
public abstract class TerminologyOperationTestBase extends FHIRServerTestBase {
    ...
    public Boolean getBooleanParameterValue(Resource resource, String propertyName) {
        return ((com.randomenterprisesolutions.fhir.model.type.Boolean) getParameter(resource, propertyName).getValue()).getValue();
    }
}
