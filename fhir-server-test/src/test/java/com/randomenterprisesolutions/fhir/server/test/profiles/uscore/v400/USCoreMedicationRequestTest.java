...
import com.randomenterprisesolutions.fhir.model.resource.MedicationRequest;
...
/**
 * Tests the US Core 4.0.0 Profile with MedicationRequest.
...
public class USCoreMedicationRequestTest extends ProfilesTestBaseV2 {
    ...
    public List<String> getRequiredProfiles() {
        return Arrays.asList("http://hl7.org/fhir/us/core/StructureDefinition/us-core-medicationrequest|4.0.0", "http://hl7.org/fhir/us/core/StructureDefinition/us-core-medication|4.0.0");
    }
    ...
    public void loadMedicationRequest1() throws Exception {
        ...
        medicationRequestId1 = buildAndAssertOnResourceForUsCore(cls, "400", resource);
    }

    public void loadMedicationRequest2() throws Exception {
        String resource = "MedicationRequest-uscore-mo2.json";
        String cls = "MedicationRequest";
        medicationRequestId2 = buildAndAssertOnResourceForUsCore(cls, "400", resource);
    }

    public void loadMedicationRequest4() throws Exception {
        String resource = "MedicationRequest-self-tylenol.json";
        String cls = "MedicationRequest";
        medicationRequestId4 = buildAndAssertOnResourceForUsCore(cls, "400", resource);
    }
