...
package com.randomenterprisesolutions.fhir.server.test.profiles.uscore.v400;
...
import com.randomenterprisesolutions.fhir.ig.us.core.tool.USCoreExamplesUtil;
...
public class USCoreAllergyIntoleranceTest extends ProfilesTestBaseV2 {
    ...
    public void loadAllergyIntoleranceInactive() throws Exception {
        ...
        CodeableConcept allergyIntoleranceClinicalStatusCodes = CodeableConcept.builder()
                .coding(Coding.builder()
                    ...
                    .display(com.randomenterprisesolutions.fhir.model.type.String.of("Inactive"))
    ...
    public void loadAllergyIntoleranceResolved() throws Exception {
        ...
        CodeableConcept allergyIntoleranceClinicalStatusCodes = CodeableConcept.builder()
                .coding(Coding.builder()
                    ...
                    .display(com.randomenterprisesolutions.fhir.model.type.String.of("Resolved"))
                    .system(Uri.of("http://terminology.hl7.org/CodeSystem/allergyintolerance-clinical"))
                    .build())
                .build();
        // @formatter:on
    ...
    public void loadProvenanceForAllergyIntoleranceIdActive() throws Exception {
        ...
        CodeableConcept type = CodeableConcept.builder()
                .coding(Coding.builder()
                    .code(Code.of("author"))
                    .display(com.randomenterprisesolutions.fhir.model.type.String.of("Author"))
        ...
        Provenance provenance =
                Provenance.builder()
                    ...
                    .target(Reference.builder()
                        .reference(com.randomenterprisesolutions.fhir.model.type.String.of("AllergyIntolerance/" + allergyIntoleranceIdActive)).build())
                    .recorded(Instant.now())
                    .agent(Agent.builder()
                        .type(type)
                        .who(Reference.builder()
                            .reference(com.randomenterprisesolutions.fhir.model.type.String.of("Practitioner/practitioner-1")).build())
                        .onBehalfOf(Reference.builder()
                            .reference(com.randomenterprisesolutions.fhir.model.type.String.of("Organization/saint-luke-w-endpoint"))
                            .build())
                        .build())
                    .build();
