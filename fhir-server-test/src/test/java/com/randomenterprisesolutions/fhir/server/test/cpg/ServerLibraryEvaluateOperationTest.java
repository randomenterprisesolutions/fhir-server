 ...
 */
package com.randomenterprisesolutions.fhir.server.test.cpg;
...
public class ServerLibraryEvaluateOperationTest extends BaseCPGOperationTest {
    ...
    public void testLibraryEvaluatePost() {
        ...
        assertEquals(((com.randomenterprisesolutions.fhir.model.type.String)pReturn.getPart().get(0).getValue()).getValue(), "[]");
    }
