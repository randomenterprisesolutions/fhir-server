...
import static com.randomenterprisesolutions.fhir.model.type.String.of;
...
import com.randomenterprisesolutions.fhir.model.resource.NutritionOrder;
...
import com.randomenterprisesolutions.fhir.model.resource.Procedure.Performer;
...
import com.randomenterprisesolutions.fhir.model.type.code.LinkType;
import com.randomenterprisesolutions.fhir.model.type.code.NutritionOrderIntent;
import com.randomenterprisesolutions.fhir.model.type.code.NutritionOrderStatus;
...
public class SearchRevIncludeTest extends FHIRServerTestBase {
    ...
    public void testCreateLibrary() throws Exception {
        ...
        library = library.toBuilder()
                ...
                .version(com.randomenterprisesolutions.fhir.model.type.String.string("1.0"))
                .name(of(tag))
                .build();
