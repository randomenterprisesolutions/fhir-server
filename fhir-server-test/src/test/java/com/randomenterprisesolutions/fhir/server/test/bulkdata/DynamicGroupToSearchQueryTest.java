...
package com.randomenterprisesolutions.fhir.server.test.bulkdata;
...
import com.randomenterprisesolutions.fhir.search.group.GroupSearchCompiler;
import com.randomenterprisesolutions.fhir.search.group.GroupSearchCompilerFactory;
import com.randomenterprisesolutions.fhir.server.test.BundleTest;
...
public class DynamicGroupToSearchQueryTest extends FHIRServerTestBase {
    ...
    public void shutdown() {
        for (com.randomenterprisesolutions.fhir.model.resource.Bundle.Entry entry : sampleBundle.getEntry()) {
    ...
    public void testDynamicGroupToSearchQueryTest() throws Exception {
        ...
        for (com.randomenterprisesolutions.fhir.model.resource.Bundle.Entry entry : bundle.getEntry()) {
            String id = entry.getResource().getId();
            String resourceType = entry.getResource().getClass().getSimpleName();
