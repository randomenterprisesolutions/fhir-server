...
import com.randomenterprisesolutions.fhir.audit.configuration.ConfigurationTranslator;
...
import com.randomenterprisesolutions.fhir.config.ConfigurationService;
...
public class BundleTest extends FHIRServerTestBase {
    ...
    public void testBatchUpdates() throws Exception {
        ...
        patientB2 = patientB2.toBuilder().active(com.randomenterprisesolutions.fhir.model.type.Boolean.TRUE).build();
        patientB1 = patientB1.toBuilder().active(com.randomenterprisesolutions.fhir.model.type.Boolean.FALSE).build();
    ...
    public void testBatchUpdatesVersionAwareError1() throws Exception {
        ...
        // Make a small change to each patient.
        patientVA2 = patientVA2.toBuilder().active(com.randomenterprisesolutions.fhir.model.type.Boolean.TRUE).build();
        patientVA1 = patientVA1.toBuilder().active(com.randomenterprisesolutions.fhir.model.type.Boolean.FALSE).build();
    ...
    public void testTransactionBundleWithSkippableUpdates() throws Exception {
        ...
        Parameters nopPatch = Parameters.builder()
                .parameter(Parameter.builder()
                    ...
                    .part(Parameter.builder()
                        .name(string("value"))
                        .value(com.randomenterprisesolutions.fhir.model.type.Boolean.TRUE)
                        .build())
                    .build())
                .build();
