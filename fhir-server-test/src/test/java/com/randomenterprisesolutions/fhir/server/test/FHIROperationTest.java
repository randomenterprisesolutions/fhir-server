...
import com.randomenterprisesolutions.fhir.model.resource.Composition.Section;
...
public class FHIROperationTest extends FHIRServerTestBase {
    ...
    public void testPostHelloOperation() throws Exception {
        ...
        assertEquals(((com.randomenterprisesolutions.fhir.model.type.String) output.getParameter().get(0).getValue()).getValue(),
                message);
    }
