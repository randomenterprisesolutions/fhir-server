...
/**
 * Tests the US Core 4.0.0 Profile with Location.
...
public class USCoreLocationTest extends ProfilesTestBaseV2 {
    ...
    public List<String> getRequiredProfiles() {
        return Arrays.asList("http://hl7.org/fhir/us/core/StructureDefinition/us-core-location|4.0.0");
    }

    @Override
    public void loadResources() throws Exception {
        String resource = "Location-hl7east.json";
        Location location = USCoreExamplesUtil.readLocalJSONResource("400", resource);
