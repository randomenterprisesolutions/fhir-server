...
/**
 * Tests the US Core 4.0.0 Profile with Condition.
 */
public class USCoreConditionTest extends ProfilesTestBaseV2 {
    ...
    public List<String> getRequiredProfiles() {
        return Arrays.asList("http://hl7.org/fhir/us/core/StructureDefinition/us-core-condition|4.0.0");
    }

    public void loadCondition1() throws Exception {
        String resource = "Condition-example.json";
        Condition condition = USCoreExamplesUtil.readLocalJSONResource("400", resource);
