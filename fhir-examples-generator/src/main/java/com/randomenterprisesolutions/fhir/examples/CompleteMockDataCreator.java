...
package com.randomenterprisesolutions.fhir.examples;
...
import com.randomenterprisesolutions.fhir.model.builder.Builder;
import com.randomenterprisesolutions.fhir.model.resource.AdministrableProductDefinition;
import com.randomenterprisesolutions.fhir.model.resource.AdverseEvent;
import com.randomenterprisesolutions.fhir.model.resource.AllergyIntolerance;
import com.randomenterprisesolutions.fhir.model.resource.Appointment;
import com.randomenterprisesolutions.fhir.model.resource.AuditEvent;
import com.randomenterprisesolutions.fhir.model.resource.CarePlan;
import com.randomenterprisesolutions.fhir.model.resource.ClaimResponse;
import com.randomenterprisesolutions.fhir.model.resource.ClinicalUseDefinition;
import com.randomenterprisesolutions.fhir.model.resource.CodeSystem;
import com.randomenterprisesolutions.fhir.model.resource.Composition;
import com.randomenterprisesolutions.fhir.model.resource.Condition;
import com.randomenterprisesolutions.fhir.model.resource.CoverageEligibilityResponse;
import com.randomenterprisesolutions.fhir.model.resource.ExplanationOfBenefit;
import com.randomenterprisesolutions.fhir.model.resource.FamilyMemberHistory;
import com.randomenterprisesolutions.fhir.model.resource.HealthcareService;
import com.randomenterprisesolutions.fhir.model.resource.InsurancePlan;
...
import com.randomenterprisesolutions.fhir.model.resource.MedicinalProductDefinition;
import com.randomenterprisesolutions.fhir.model.resource.MessageDefinition;
import com.randomenterprisesolutions.fhir.model.resource.MolecularSequence;
...
import com.randomenterprisesolutions.fhir.model.resource.RelatedPerson;
import com.randomenterprisesolutions.fhir.model.resource.Resource;
import com.randomenterprisesolutions.fhir.model.resource.RiskAssessment;
import com.randomenterprisesolutions.fhir.model.resource.SubstanceDefinition;
import com.randomenterprisesolutions.fhir.model.resource.SupplyDelivery;
import com.randomenterprisesolutions.fhir.model.resource.Task;
...
import com.randomenterprisesolutions.fhir.model.type.code.AddressUse;
import com.randomenterprisesolutions.fhir.model.type.code.CapabilityStatementKind;
import com.randomenterprisesolutions.fhir.model.type.code.CompartmentType;
import com.randomenterprisesolutions.fhir.model.type.code.ContactPointUse;
import com.randomenterprisesolutions.fhir.model.type.code.QuestionnaireItemOperator;
import com.randomenterprisesolutions.fhir.model.type.code.QuestionnaireItemType;
import com.randomenterprisesolutions.fhir.model.type.code.ResourceTypeCode;
import com.randomenterprisesolutions.fhir.model.type.code.TriggerType;
import com.randomenterprisesolutions.fhir.model.util.ValidationSupport;
...
public class CompleteMockDataCreator extends DataCreatorBase {
    ...
    @Override
    protected Builder<?> addData(com.randomenterprisesolutions.fhir.model.type.Reference.Builder builder, String targetProfile) throws Exception {
                    ...
                    // CodeableConcepts with required bindings
                        ...
                        argument = CodeableConcept.builder()
                                .coding(Coding.builder()
                                    ...
                                    .userSelected(com.randomenterprisesolutions.fhir.model.type.Boolean.FALSE)
                                    .build())
                                .text(string(value))
                                .build();
    ...
    protected Element.Builder createPrimitive(Element.Builder builder) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
        if (builder instanceof com.randomenterprisesolutions.fhir.model.type.Boolean.Builder) {
            handleBoolean((com.randomenterprisesolutions.fhir.model.type.Boolean.Builder) builder);
        } else if (builder instanceof com.randomenterprisesolutions.fhir.model.type.Integer.Builder) {
            handleInteger((com.randomenterprisesolutions.fhir.model.type.Integer.Builder) builder);
        } else if (builder instanceof com.randomenterprisesolutions.fhir.model.type.Decimal.Builder) {
            handleDecimal((com.randomenterprisesolutions.fhir.model.type.Decimal.Builder) builder);
        ...
        } else if (builder instanceof com.randomenterprisesolutions.fhir.model.type.String.Builder) {
            handleString((com.randomenterprisesolutions.fhir.model.type.String.Builder) builder);
    ...
    protected void handleBoolean(com.randomenterprisesolutions.fhir.model.type.Boolean.Builder bool) {
        bool.value(podam.manufacturePojo(Boolean.class));
    }

    protected void handleId(com.randomenterprisesolutions.fhir.model.type.Id.Builder string) {
        string.value(podam.manufacturePojo(String.class).replace("_", "-"));
    }

    protected void handleString(com.randomenterprisesolutions.fhir.model.type.String.Builder string) {
        string.value(podam.manufacturePojo(String.class));
    }

    protected void handleInteger(com.randomenterprisesolutions.fhir.model.type.Integer.Builder integer) {
        integer.value(podam.manufacturePojo(Integer.class));
    }

    protected void handleDecimal(com.randomenterprisesolutions.fhir.model.type.Decimal.Builder decimal) {
        decimal.value(podam.manufacturePojo(BigDecimal.class));
    }

    private void handleUuid(com.randomenterprisesolutions.fhir.model.type.Uuid.Builder uuid) {
        uuid.value("urn:uuid:" + UUID.randomUUID().toString());
    }

    private void handleOid(com.randomenterprisesolutions.fhir.model.type.Oid.Builder oid) {
