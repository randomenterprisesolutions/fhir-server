...
import com.randomenterprisesolutions.fhir.bucket.api.ResourceEntry;
...
public abstract class BaseFileReader {
    ...
    // The file type we are configured to process
     ...
     * @param job
     */
    protected abstract void processThr(final BucketLoaderJob job);
     ...
     * @param reader
     */
    protected void processJSON(final BucketLoaderJob job, final Reader reader) {
     ...
     * @return
     */
    protected void processNDJSON(final BucketLoaderJob job, final BufferedReader br) {
     ...
     */
    private boolean process(BucketLoaderJob job, Resource resource, int lineNumber, String line) {
