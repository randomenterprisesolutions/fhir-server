...
package com.randomenterprisesolutions.fhir.server.resolve;
...
public class ServerResolveFunction extends ResolveFunction {
    ...
    public static final String RESOURCE_CACHE_NAME = "com.randomenterprisesolutions.fhir.server.resolve.ServerResolveFunction.resourceCache";
