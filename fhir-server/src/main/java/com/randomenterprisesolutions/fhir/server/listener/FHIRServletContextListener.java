...
package com.randomenterprisesolutions.fhir.server.listener;

import static com.randomenterprisesolutions.fhir.config.FHIRConfiguration.PROPERTY_CHECK_CONTROL_CHARS;
import static com.randomenterprisesolutions.fhir.config.FHIRConfiguration.PROPERTY_CHECK_REFERENCE_TYPES;
import static com.randomenterprisesolutions.fhir.config.FHIRConfiguration.PROPERTY_DATASOURCES;
import static com.randomenterprisesolutions.fhir.config.FHIRConfiguration.PROPERTY_EXTENDED_CODEABLE_CONCEPT_VALIDATION;
import static com.randomenterprisesolutions.fhir.config.FHIRConfiguration.PROPERTY_KAFKA_CONNECTIONPROPS;
import static com.randomenterprisesolutions.fhir.config.FHIRConfiguration.PROPERTY_KAFKA_ENABLED;
import static com.randomenterprisesolutions.fhir.config.FHIRConfiguration.PROPERTY_KAFKA_INDEX_SERVICE_CONNECTIONPROPS;
import static com.randomenterprisesolutions.fhir.config.FHIRConfiguration.PROPERTY_KAFKA_INDEX_SERVICE_MODE;
import static com.randomenterprisesolutions.fhir.config.FHIRConfiguration.PROPERTY_KAFKA_INDEX_SERVICE_TOPICNAME;
import static com.randomenterprisesolutions.fhir.config.FHIRConfiguration.PROPERTY_KAFKA_TOPICNAME;
import static com.randomenterprisesolutions.fhir.config.FHIRConfiguration.PROPERTY_NATS_CHANNEL;
import static com.randomenterprisesolutions.fhir.config.FHIRConfiguration.PROPERTY_NATS_CLIENT;
import static com.randomenterprisesolutions.fhir.config.FHIRConfiguration.PROPERTY_NATS_CLUSTER;
import static com.randomenterprisesolutions.fhir.config.FHIRConfiguration.PROPERTY_NATS_ENABLED;
import static com.randomenterprisesolutions.fhir.config.FHIRConfiguration.PROPERTY_NATS_KEYSTORE;
import static com.randomenterprisesolutions.fhir.config.FHIRConfiguration.PROPERTY_NATS_KEYSTORE_PW;
import static com.randomenterprisesolutions.fhir.config.FHIRConfiguration.PROPERTY_NATS_SERVERS;
import static com.randomenterprisesolutions.fhir.config.FHIRConfiguration.PROPERTY_NATS_TLS_ENABLED;
import static com.randomenterprisesolutions.fhir.config.FHIRConfiguration.PROPERTY_NATS_TRUSTSTORE;
import static com.randomenterprisesolutions.fhir.config.FHIRConfiguration.PROPERTY_NATS_TRUSTSTORE_PW;
import static com.randomenterprisesolutions.fhir.config.FHIRConfiguration.PROPERTY_REMOTE_INDEX_SERVICE_INSTANCEIDENTIFIER;
import static com.randomenterprisesolutions.fhir.config.FHIRConfiguration.PROPERTY_REMOTE_INDEX_SERVICE_TYPE;
import static com.randomenterprisesolutions.fhir.config.FHIRConfiguration.PROPERTY_SERVER_REGISTRY_RESOURCE_PROVIDER_ENABLED;
import static com.randomenterprisesolutions.fhir.config.FHIRConfiguration.PROPERTY_SERVER_RESOLVE_FUNCTION_ENABLED;
import static com.randomenterprisesolutions.fhir.config.FHIRConfiguration.PROPERTY_WEBSOCKET_ENABLED;
...
import com.randomenterprisesolutions.fhir.config.CallTimeMetric;
...
import com.randomenterprisesolutions.fhir.config.PropertyGroup.PropertyEntry;
import com.randomenterprisesolutions.fhir.core.lifecycle.EventManager;
import com.randomenterprisesolutions.fhir.database.utils.derby.DerbyServerPropertiesMgr;
import com.randomenterprisesolutions.fhir.database.utils.thread.ThreadHandler;
import com.randomenterprisesolutions.fhir.model.config.FHIRModelConfig;
import com.randomenterprisesolutions.fhir.model.lang.util.LanguageRegistryUtil;
...
import com.randomenterprisesolutions.fhir.path.function.registry.FHIRPathFunctionRegistry;
import com.randomenterprisesolutions.fhir.persistence.exception.FHIRPersistenceException;
import com.randomenterprisesolutions.fhir.persistence.helper.FHIRPersistenceHelper;
...
import com.randomenterprisesolutions.fhir.server.index.kafka.FHIRRemoteIndexKafkaService;
import com.randomenterprisesolutions.fhir.server.index.kafka.KafkaPropertyAdapter;
import com.randomenterprisesolutions.fhir.server.notification.kafka.FHIRNotificationKafkaPublisher;
import com.randomenterprisesolutions.fhir.server.notification.websocket.FHIRNotificationServiceEndpointConfig;
import com.randomenterprisesolutions.fhir.server.notifications.nats.FHIRNotificationNATSPublisher;
...
import com.randomenterprisesolutions.fhir.server.resolve.ServerResolveFunction;
import com.randomenterprisesolutions.fhir.server.spi.operation.FHIROperationUtil;
import com.randomenterprisesolutions.fhir.term.config.FHIRTermConfig;
import com.randomenterprisesolutions.fhir.term.graph.provider.GraphTermServiceProvider;
import com.randomenterprisesolutions.fhir.term.remote.provider.RemoteTermServiceProvider;
import com.randomenterprisesolutions.fhir.term.remote.provider.RemoteTermServiceProvider.Configuration;
import com.randomenterprisesolutions.fhir.term.remote.provider.RemoteTermServiceProvider.Configuration.BasicAuth;
import com.randomenterprisesolutions.fhir.term.remote.provider.RemoteTermServiceProvider.Configuration.Header;
import com.randomenterprisesolutions.fhir.term.remote.provider.RemoteTermServiceProvider.Configuration.Supports;
import com.randomenterprisesolutions.fhir.term.remote.provider.RemoteTermServiceProvider.Configuration.TrustStore;
...
public class FHIRServletContextListener implements ServletContextListener {
    ...
    public static final String FHIR_SERVER_INIT_COMPLETE = "com.randomenterprisesolutions.fhir.webappInitComplete";
