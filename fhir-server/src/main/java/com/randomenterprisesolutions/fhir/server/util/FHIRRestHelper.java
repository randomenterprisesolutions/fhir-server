...
import static com.randomenterprisesolutions.fhir.config.FHIRConfiguration.PROPERTY_VALIDATION_FAIL_FAST;
...
import static com.randomenterprisesolutions.fhir.server.util.FHIRRestSupport.getEtagValue;
...
import com.randomenterprisesolutions.fhir.core.HTTPHandlingPreference;
...
import com.randomenterprisesolutions.fhir.database.utils.api.LockException;
import com.randomenterprisesolutions.fhir.exception.FHIROperationException;
import com.randomenterprisesolutions.fhir.model.patch.FHIRPatch;
...
import com.randomenterprisesolutions.fhir.model.resource.Bundle.Entry.Search;
...
import com.randomenterprisesolutions.fhir.model.type.code.SearchEntryMode;
import com.randomenterprisesolutions.fhir.model.util.CollectingVisitor;
...
import com.randomenterprisesolutions.fhir.model.util.SaltHash;
import com.randomenterprisesolutions.fhir.model.visitor.ResourceFingerprintVisitor;
...
import com.randomenterprisesolutions.fhir.persistence.ResourceChangeLogRecord.ChangeType;
...
import com.randomenterprisesolutions.fhir.persistence.context.FHIRSystemHistoryContext;
import com.randomenterprisesolutions.fhir.persistence.context.impl.FHIRPersistenceContextImpl;
...
import com.randomenterprisesolutions.fhir.persistence.exception.FHIRPersistenceIfNoneMatchException;
import com.randomenterprisesolutions.fhir.persistence.helper.FHIRTransactionHelper;
import com.randomenterprisesolutions.fhir.persistence.payload.PayloadPersistenceResponse;
import com.randomenterprisesolutions.fhir.persistence.util.FHIRPersistenceUtil;
...
import com.randomenterprisesolutions.fhir.server.exception.FHIRResourceDeletedException;
import com.randomenterprisesolutions.fhir.server.exception.FHIRResourceNotFoundException;
import com.randomenterprisesolutions.fhir.server.interceptor.FHIRPersistenceInterceptorMgr;
import com.randomenterprisesolutions.fhir.server.operation.FHIROperationRegistry;
import com.randomenterprisesolutions.fhir.server.rest.FHIRRestInteraction;
import com.randomenterprisesolutions.fhir.server.rest.FHIRRestInteractionVisitorMeta;
import com.randomenterprisesolutions.fhir.server.rest.FHIRRestInteractionVisitorOffload;
import com.randomenterprisesolutions.fhir.server.rest.FHIRRestInteractionVisitorPersist;
import com.randomenterprisesolutions.fhir.server.rest.FHIRRestInteractionVisitorReferenceMapping;
...
import com.randomenterprisesolutions.fhir.validation.exception.FHIRValidationException;
...
public class FHIRRestHelper implements FHIRResourceHelpers {
    ...
    private static final com.randomenterprisesolutions.fhir.model.type.String SC_BAD_REQUEST_STRING = string(Integer.toString(SC_BAD_REQUEST));
    private static final com.randomenterprisesolutions.fhir.model.type.String SC_ACCEPTED_STRING = string(Integer.toString(SC_ACCEPTED));
    ...
    public FHIRRestOperationResponse doCreateMeta(FHIRPersistenceEvent event, List<Issue> warnings, String type, Resource resource,
        ...
        try {
            ...
            final com.randomenterprisesolutions.fhir.model.type.Instant lastUpdated = FHIRPersistenceSupport.getCurrentInstant();
    ...
    public FHIRRestOperationResponse doUpdateMeta(FHIRPersistenceEvent event, String type, String id, FHIRPatch patch, Resource newResource,
        ...
        try {
            ...
            final com.randomenterprisesolutions.fhir.model.type.Instant lastUpdated = FHIRPersistenceSupport.getNewLastUpdatedInstant(currentLastUpdated);
            ...
            for (ResourceResult<? extends Resource> resourceResult : resourceResults) {
                ...
                if (resource != null) {
                    ...
                    Bundle.Entry.Response response = Bundle.Entry.Response.builder()
                            ...
                            .lastModified(com.randomenterprisesolutions.fhir.model.type.Instant.of(resourceResult.getLastUpdated().atZone(UTC)))
                            .build();
    ...
    public void validateInteraction(Interaction interaction, String resourceType) throws FHIROperationException {
        ...
        com.randomenterprisesolutions.fhir.config.Interaction configInteraction = com.randomenterprisesolutions.fhir.config.Interaction.from(interaction.value());
    ...
    public Bundle doHistory(MultivaluedMap<String, String> queryParameters, String requestUri, String resourceType) throws Exception {
        ...
        for (int i=0; i<records.size(); i++) {
            ...
            responseBuilder.lastModified(com.randomenterprisesolutions.fhir.model.type.Instant.of(changeRecord.getChangeTstamp().atZone(UTC)));
        ...
        if (changeIdMarker != null || lastChangeTime != null) {
            ...
            linkBuilder.relation(com.randomenterprisesolutions.fhir.model.type.String.of("next"));
        ...
        linkBuilder.relation(com.randomenterprisesolutions.fhir.model.type.String.of("self"));
        bundleBuilder.link(linkBuilder.build());
