 ...
 */
 ...
 package com.randomenterprisesolutions.fhir.server.resources.filters;
...
public class FHIRVersionRequestFilter implements ContainerRequestFilter {
    public static final String FHIR_VERSION_PROP = "com.randomenterprisesolutions.fhir.server.fhirVersion";
