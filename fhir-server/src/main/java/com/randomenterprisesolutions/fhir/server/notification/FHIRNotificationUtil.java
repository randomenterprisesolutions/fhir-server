...
package com.randomenterprisesolutions.fhir.server.notification;
        ...
        if (!"delete".equals(event.getOperationType()) && includeResource && event.getResource() != null) {
            ...
            if (length > maxSize) {
                ...
                if ("subset".equals(subset)) {
                    ...
                    com.randomenterprisesolutions.fhir.model.resource.Resource resource = FHIRParser.parser(Format.JSON)
