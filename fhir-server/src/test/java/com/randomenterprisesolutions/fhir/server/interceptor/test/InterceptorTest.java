package com.randomenterprisesolutions.fhir.server.interceptor.test;
/*
...
public class InterceptorTest {
    ...
    public void setUp() throws Exception {
        ...
        badPatient = patient.toBuilder()
                            ...
                            .name(HumanName.builder().family(com.randomenterprisesolutions.fhir.model.type.String.of("Exception")).build())
                            .build();
