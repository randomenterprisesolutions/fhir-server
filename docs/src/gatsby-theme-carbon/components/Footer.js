...
const Content = () => (
  <>
    <p>
      The randomenterprisesolutions FHIR Server is licensed under the Apache 2.0 license. Full license text is available at <a href="https://randomenterprisesolutions.github.io/fhir-server/LICENSE">LICENSE</a>.
    </p>
    <p>
...
const links = {
  firstCol: [
    { href: 'https://github.com/randomenterprisesolutions/fhir', linkText: 'randomenterprisesolutions/FHIR on GitHub' },
