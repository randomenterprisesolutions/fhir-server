...
package com.randomenterprisesolutions.fhir.path.util;
...
import com.randomenterprisesolutions.fhir.model.util.ModelSupport.ElementInfo;
import com.randomenterprisesolutions.fhir.model.visitor.Visitable;
import com.randomenterprisesolutions.fhir.path.ClassInfo;
import com.randomenterprisesolutions.fhir.path.ClassInfoElement;
...
import com.randomenterprisesolutions.fhir.path.FHIRPathNumberValue;
...
import com.randomenterprisesolutions.fhir.path.SimpleTypeInfo;
import com.randomenterprisesolutions.fhir.path.TupleTypeInfo;
import com.randomenterprisesolutions.fhir.path.TupleTypeInfoElement;
...
public final class FHIRPathUtil {
     ...
     */
    public static com.randomenterprisesolutions.fhir.model.type.String getVersion(FHIRPathTree tree, FHIRPathElementNode elementNode) {
        if (tree != null) {
     ...
     */
    public static com.randomenterprisesolutions.fhir.model.type.String getDisplay(FHIRPathTree tree, FHIRPathElementNode elementNode) {
        if (tree != null) {
