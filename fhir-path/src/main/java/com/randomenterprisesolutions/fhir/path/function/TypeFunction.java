...
import static com.randomenterprisesolutions.fhir.path.util.FHIRPathUtil.buildClassInfo;
import static com.randomenterprisesolutions.fhir.path.util.FHIRPathUtil.buildSimpleTypeInfo;
import static com.randomenterprisesolutions.fhir.path.util.FHIRPathUtil.buildTupleTypeInfo;
