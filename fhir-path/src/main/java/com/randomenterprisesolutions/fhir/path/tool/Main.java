...
package com.randomenterprisesolutions.fhir.path.tool;
...
public final class Main {
    ...
    private static class OutputPrinter implements FHIRPathNodeVisitor {
         ...
         * via the {@link com.randomenterprisesolutions.fhir.model.resource.Resource} toString() implementation.
         */
        @Override
         ...
         * via the {@link com.randomenterprisesolutions.fhir.model.type.Element} toString() implementation.
         */
        @Override
