...
import static com.randomenterprisesolutions.fhir.path.util.FHIRPathUtil.convertsToBoolean;
...
public class ConvertsToBooleanFunction extends FHIRPathAbstractFunction {
    @Override
    ...
    public Collection<FHIRPathNode> apply(EvaluationContext evaluationContext, Collection<FHIRPathNode> context, List<Collection<FHIRPathNode>> arguments) {
        return convertsToBoolean(context) ? SINGLETON_TRUE : SINGLETON_FALSE;
    }
}
