...
import static com.randomenterprisesolutions.fhir.model.util.ModelSupport.FHIR_STRING;
...
import static com.randomenterprisesolutions.fhir.path.util.FHIRPathUtil.getDisplay;
...
import static com.randomenterprisesolutions.fhir.path.util.FHIRPathUtil.getSystem;
import static com.randomenterprisesolutions.fhir.path.util.FHIRPathUtil.getVersion;
import static com.randomenterprisesolutions.fhir.path.util.FHIRPathUtil.isCodedElementNode;
import static com.randomenterprisesolutions.fhir.path.util.FHIRPathUtil.isQuantityNode;
import static com.randomenterprisesolutions.fhir.path.util.FHIRPathUtil.isStringElementNode;
import static com.randomenterprisesolutions.fhir.path.util.FHIRPathUtil.isStringValue;
import static com.randomenterprisesolutions.fhir.path.util.FHIRPathUtil.isUriElementNode;
...
import com.randomenterprisesolutions.fhir.model.resource.ValueSet.Compose;
import com.randomenterprisesolutions.fhir.model.resource.ValueSet.Compose.Include;
...
public class MemberOfFunction extends FHIRPathAbstractFunction {
            ...
            if (isExpanded(valueSet) || service.isExpandable(valueSet)) {
                try {
                    ...
                    if (element.is(Code.class)) {
                        ...
                        com.randomenterprisesolutions.fhir.model.type.String version = getVersion(tree, elementNode);
                        Code code = element.as(Code.class);
                        com.randomenterprisesolutions.fhir.model.type.String display = getDisplay(tree, elementNode);
    ...
    private boolean validateCode(FHIRTermService service, ValueSet valueSet, Uri system, com.randomenterprisesolutions.fhir.model.type.String version, Code code, com.randomenterprisesolutions.fhir.model.type.String display, EvaluationContext evaluationContext, FHIRPathElementNode elementNode, String strength) {
    ...
    private boolean convertsToCodeSystemValidateCode(ValueSet valueSet, Uri system, com.randomenterprisesolutions.fhir.model.type.String version, Code code) {
    ...
    private boolean hasCodeSystem(ValueSet valueSet, Uri system, com.randomenterprisesolutions.fhir.model.type.String version) {
    ...
    private CodeSystem getCodeSystem(ValueSet valueSet, Uri system, com.randomenterprisesolutions.fhir.model.type.String version) {
        Compose compose = valueSet.getCompose();
        for (Include include : compose.getInclude()) {
