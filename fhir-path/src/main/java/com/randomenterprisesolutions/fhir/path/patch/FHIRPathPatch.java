    ...
    private static void addOperation(Builder builder, Parameter operation) {
        ...
        for (Parameter part : operation.getPart()) {
            ...
            case FHIRPathPatchOperation.PATH:
                fhirPath = validatePartAndGetValue(foundPath, part, com.randomenterprisesolutions.fhir.model.type.String.class).getValue();
                foundPath = true;
                break;
            case FHIRPathPatchOperation.NAME:
                name = validatePartAndGetValue(foundName, part, com.randomenterprisesolutions.fhir.model.type.String.class).getValue();
                foundName = true;
                break;
            ...
            case FHIRPathPatchOperation.INDEX:
                index = validatePartAndGetValue(foundIndex, part, com.randomenterprisesolutions.fhir.model.type.Integer.class).getValue();
                foundIndex = true;
                break;
            case FHIRPathPatchOperation.SOURCE:
                source = validatePartAndGetValue(foundSource, part, com.randomenterprisesolutions.fhir.model.type.Integer.class).getValue();
                foundSource = true;
                break;
            case FHIRPathPatchOperation.DESTINATION:
                destination = validatePartAndGetValue(foundDestination, part, com.randomenterprisesolutions.fhir.model.type.Integer.class).getValue();
