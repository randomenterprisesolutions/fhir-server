...
public class FHIRPathUtilPatchTest {
    ...
    private void testRemoveElementId() throws FHIRPathException, FHIRPatchException {
        Patient modifiedPatient = FHIRPathUtil.add(patient, "Patient", "active", com.randomenterprisesolutions.fhir.model.type.Boolean.builder()
                .id("elementId")
                .value(true)
                .build());
    ...
    private void testRemoveValue_invalid() throws FHIRPathException, FHIRPatchException {
        Patient modifiedPatient = FHIRPathUtil.add(patient, "Patient", "active", com.randomenterprisesolutions.fhir.model.type.Boolean.TRUE);
