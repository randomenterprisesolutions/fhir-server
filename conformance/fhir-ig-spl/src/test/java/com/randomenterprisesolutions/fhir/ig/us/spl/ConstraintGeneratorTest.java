        ...
        for (FHIRRegistryResource registryResource : provider.getRegistryResources()) {
            if (StructureDefinition.class.equals(registryResource.getResourceType())) {
                ...
                if ("resource".equals(kind) || "complex-type".equals(kind)) {
                    Class<?> type = ModelSupport.isResourceType(registryResource.getType()) ? ModelSupport.getResourceType(registryResource.getType()) : Class.forName("com.randomenterprisesolutions.fhir.model.type." + registryResource.getType());
