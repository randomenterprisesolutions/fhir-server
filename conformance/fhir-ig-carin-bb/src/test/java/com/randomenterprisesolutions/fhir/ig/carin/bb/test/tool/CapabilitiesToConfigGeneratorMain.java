    ...
    public static void main(String[] args) throws Exception {
        ...
        for (String version : main.versions()) {
            ...
            try (BufferedReader reader = new BufferedReader(new FileReader(file))) {
                CapabilityStatement statement = FHIRParser.parser(Format.JSON).parse(reader).as(com.randomenterprisesolutions.fhir.model.resource.CapabilityStatement.class);
