...
package com.randomenterprisesolutions.fhir.operation.document;
    ...
    protected Parameters doInvoke(FHIROperationContext operationContext, Class<? extends Resource> resourceType, String logicalId,
        ...
        try {
            ...
            if (persistParameter != null) {
                com.randomenterprisesolutions.fhir.model.type.Boolean persistParameterValue = persistParameter.getValue().as(com.randomenterprisesolutions.fhir.model.type.Boolean.class); //getValueBoolean();
