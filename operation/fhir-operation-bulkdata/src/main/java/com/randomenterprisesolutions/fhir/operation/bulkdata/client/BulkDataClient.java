...
package com.randomenterprisesolutions.fhir.operation.bulkdata.client;
...
import com.randomenterprisesolutions.fhir.operation.bulkdata.client.action.batch.BatchCancelRequestAction;
import com.randomenterprisesolutions.fhir.operation.bulkdata.config.ConfigurationAdapter;
import com.randomenterprisesolutions.fhir.operation.bulkdata.model.JobExecutionResponse;
import com.randomenterprisesolutions.fhir.operation.bulkdata.model.JobInstanceRequest;
import com.randomenterprisesolutions.fhir.operation.bulkdata.model.JobInstanceResponse;
import com.randomenterprisesolutions.fhir.operation.bulkdata.model.PollingLocationResponse;
import com.randomenterprisesolutions.fhir.operation.bulkdata.model.type.Input;
import com.randomenterprisesolutions.fhir.operation.bulkdata.model.type.JobParameter;
import com.randomenterprisesolutions.fhir.operation.bulkdata.model.type.JobType;
...
import com.randomenterprisesolutions.fhir.operation.bulkdata.model.url.DownloadUrl;
            ...
            for (int i = 0; i < bulkExportJobInstanceResponse.getExecutionId().size(); i++) {
                ...
                if (OperationConstants.FAILED_STATUS.contains(executionResponse.getBatchStatus())) {
                    if (OperationConstants.NO_SUCH_BUCKET.equals(executionResponse.getExitStatus())) {
                        // it would be better if we could cover this case preflight (https://github.com/randomenterprisesolutions/FHIR/issues/2709)
