...
package com.randomenterprisesolutions.fhir.operation.bulkdata.util;

import static com.randomenterprisesolutions.fhir.model.util.ModelSupport.FHIR_STRING;
import static com.randomenterprisesolutions.fhir.operation.bulkdata.util.CommonUtil.buildExceptionWithIssue;
...
import com.randomenterprisesolutions.fhir.operation.bulkdata.OperationConstants;
...
import com.randomenterprisesolutions.fhir.operation.bulkdata.config.OperationContextAdapter;
    ...
    public String retrieveInputFormat() throws FHIROperationException {
        try {
            ...
            while (iter.hasNext()) {
                ...
                String val = node.asElementNode().element().as(com.randomenterprisesolutions.fhir.model.type.String.class).getValue();
    ...
    public List<Input> retrieveInputs(FHIRVersionParam fhirVersion) throws FHIROperationException {
        ...
        try {
            ...
            while (iter.hasNext()) {
                ...
                String type =
                        ((FHIRPathElementNode) resultPartType.iterator().next()).element().as(com.randomenterprisesolutions.fhir.model.type.String.class).getValue();
                ...
                String url =
                        ((FHIRPathElementNode) resultPartUrl.iterator().next()).element().as(com.randomenterprisesolutions.fhir.model.type.Url.class).getValue();
            ...
            while (iter.hasNext()) {
                ...
                while (iterEncoding.hasNext()) {
                    String contentEncoding =
                            ((FHIRPathElementNode) iterEncoding.next()).element().as(com.randomenterprisesolutions.fhir.model.type.String.class).getValue();
