...
public class BulkDataExportUtil {
    ...
    public MediaType checkAndConvertToMediaType(Parameters parameters) throws FHIROperationException {
        ...
        if (parameter.isPresent() && parameter.get().getValue().is(com.randomenterprisesolutions.fhir.model.type.String.class)) {
            mediaType = retrieveOutputFormat(parameter.get().getValue().as(com.randomenterprisesolutions.fhir.model.type.String.class).getValue());
        }
            ...
            for (Parameters.Parameter parameter : parameters.getParameter()) {
                ...
                if (OperationConstants.PARAM_SINCE.equals(parameter.getName().getValue())) {
                    if (parameter.getValue() != null) {
                        if (parameter.getValue().is(com.randomenterprisesolutions.fhir.model.type.String.class)) {
                            return Instant.of(parameter.getValue().as(com.randomenterprisesolutions.fhir.model.type.String.class).getValue());
                        } else if (parameter.getValue().is(com.randomenterprisesolutions.fhir.model.type.Instant.class)) {
                            return Instant.of(parameter.getValue().as(com.randomenterprisesolutions.fhir.model.type.Instant.class).getValue());
                        }
                    }
