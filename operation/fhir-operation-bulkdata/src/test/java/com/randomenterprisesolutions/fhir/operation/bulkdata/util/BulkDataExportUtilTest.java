...
import com.randomenterprisesolutions.fhir.server.spi.operation.FHIROperationContext.Type;
...
public class BulkDataExportUtilTest {
    ...
    public void testGetOutputParametersWithJson() throws Exception {
        ...
        assertFalse(result.getParameter().get(0).getValue().as(com.randomenterprisesolutions.fhir.model.type.String.class).getValue().isEmpty());
    }
