...
package com.randomenterprisesolutions.fhir.operation.reindex;
        ...
        try {
            ...
            if (parameters != null) {
                for (Parameters.Parameter parameter : parameters.getParameter()) {
                    ...
                    if (PARAM_TSTAMP.equals(parameterNameValue)
                            ...
                            && parameter.getValue().is(com.randomenterprisesolutions.fhir.model.type.String.class)) {
                        String val = parameter.getValue().as(com.randomenterprisesolutions.fhir.model.type.String.class).getValue();
                        ...
                        String lrIdsString = parameter.getValue().as(com.randomenterprisesolutions.fhir.model.type.String.class).getValue();
                        if (lrIdsString != null) {
                        ...
                        Integer val = parameter.getValue().as(com.randomenterprisesolutions.fhir.model.type.Integer.class).getValue();
                        if (val != null) {
                        ...
                        Boolean val = parameter.getValue().as(com.randomenterprisesolutions.fhir.model.type.Boolean.class).getValue();
                        if (val != null) {
                            if (val.booleanValue()) {
                        ...
                        resourceLogicalId = parameter.getValue().as(com.randomenterprisesolutions.fhir.model.type.String.class).getValue();
            ...
            if (totalProcessed == 0) {
                ...
                result.issue(Issue.builder()
                    ...
                    .diagnostics(com.randomenterprisesolutions.fhir.model.type.String.of(diag))
                    .build());
            }
