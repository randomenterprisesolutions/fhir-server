 ...
 */
package com.randomenterprisesolutions.fhir.operation.everything;

import static com.randomenterprisesolutions.fhir.model.util.ModelSupport.FHIR_DATE;
import static com.randomenterprisesolutions.fhir.model.util.ModelSupport.FHIR_INSTANT;
...
import com.randomenterprisesolutions.fhir.model.util.ReferenceFinder;
...
import com.randomenterprisesolutions.fhir.search.parameters.IncludesUtil;
...
public class EverythingOperation extends AbstractOperation {
    ...
    protected Parameters doInvoke(FHIROperationContext operationContext, Class<? extends Resource> resourceType, String logicalId,
        ...
        // Initial list obtained from the github issue: https://github.com/randomenterprisesolutions/FHIR/issues/1044#issuecomment-769788097
