...
package com.randomenterprisesolutions.fhir.operation.erase;
...
import com.randomenterprisesolutions.fhir.operation.erase.adapter.ResourceEraseRecordAdapter;
import com.randomenterprisesolutions.fhir.operation.erase.audit.EraseOperationAuditLogger;
import com.randomenterprisesolutions.fhir.operation.erase.impl.EraseRest;
import com.randomenterprisesolutions.fhir.operation.erase.impl.EraseRestFactory;
import com.randomenterprisesolutions.fhir.operation.erase.impl.EraseRestImpl;
import com.randomenterprisesolutions.fhir.operation.erase.mock.MockAuditLogService;
import com.randomenterprisesolutions.fhir.operation.erase.mock.MockFHIRResourceHelpers;
import com.randomenterprisesolutions.fhir.operation.erase.mock.MockHttpServletRequest;
import com.randomenterprisesolutions.fhir.operation.erase.mock.MockSecurityContext;
import com.randomenterprisesolutions.fhir.operation.erase.util.EraseParametersBuilder;
...
import com.randomenterprisesolutions.fhir.persistence.ResourceEraseRecord.Status;
...
public class EraseTest {
    ...
    @Test(expectedExceptions = {com.randomenterprisesolutions.fhir.exception.FHIROperationException.class})
