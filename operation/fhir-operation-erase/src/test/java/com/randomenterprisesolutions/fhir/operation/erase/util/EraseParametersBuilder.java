 ...
 */
package com.randomenterprisesolutions.fhir.operation.erase.util;
...
public final class EraseParametersBuilder {
    ...
    public EraseParametersBuilder badReason() {
        parameters.add(Parameter.builder().name(string(REASON)).value(com.randomenterprisesolutions.fhir.model.type.Integer.of("1")).build());
        return this;
    }
    ...
    public EraseParametersBuilder absentReason() {
        com.randomenterprisesolutions.fhir.model.type.String str = com.randomenterprisesolutions.fhir.model.type.String.builder().extension(DATA_ABSENT).build();
    ...
    public EraseParametersBuilder badPatient() {
        parameters.add(Parameter.builder().name(string(PATIENT)).value(com.randomenterprisesolutions.fhir.model.type.Integer.of("1")).build());
        return this;
    }
    ...
    public EraseParametersBuilder version(Integer version) {
        parameters.add(Parameter.builder().name(string(VERSION)).value(com.randomenterprisesolutions.fhir.model.type.Integer.of(version)).build());
        return this;
    }
    ...
    public EraseParametersBuilder absentVersion() {
        com.randomenterprisesolutions.fhir.model.type.Integer itr = com.randomenterprisesolutions.fhir.model.type.Integer.builder().extension(DATA_ABSENT).build();
    ...
    public EraseParametersBuilder badId() {
        parameters.add(Parameter.builder().name(string(ID)).value(com.randomenterprisesolutions.fhir.model.type.Integer.of("1")).build());
        return this;
    }
