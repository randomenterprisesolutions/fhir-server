...
package com.randomenterprisesolutions.fhir.operation.erase.adapter;
...
public class ResourceEraseRecordAdapter {
    ...
    private static final Parameter PARTIAL_FALSE = Parameter.builder()
                                                    .name(string("partial"))
                                                    .value(com.randomenterprisesolutions.fhir.model.type.Boolean.FALSE)
                                                    .build();
    ...
    public Parameters adapt(ResourceEraseRecord eraseRecord, EraseDTO eraseDto) {
        ...
        parameters.add(Parameter.builder()
                        .name(string("total"))
                        .value(com.randomenterprisesolutions.fhir.model.type.Integer.of(eraseRecord.getTotal()))
                        .build());
