...
package com.randomenterprisesolutions.fhir.operation.erase.audit;
...
public class EraseOperationAuditLogger extends RestAuditLogger {
    ...
    public void error(Parameters request, FHIROperationException e, EraseDTO eraseDto) throws FHIROperationException {
        ...
        parameters.add(Parameter.builder().name(string("partial")).value(com.randomenterprisesolutions.fhir.model.type.Boolean.TRUE).build());
