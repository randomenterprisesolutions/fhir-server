...
public class EncodingVisitor<T extends Resource> extends CopyingVisitor<T> {
    ...
    public void visit(java.lang.String elementName, java.lang.String value) {
        ...
        if (builder instanceof com.randomenterprisesolutions.fhir.model.type.String.Builder) {
            ((com.randomenterprisesolutions.fhir.model.type.String.Builder) builder).value(newValue);
            markDirty();
