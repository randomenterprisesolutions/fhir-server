...
public class RiskAssessmentStatus extends Code {
     ...
     */
    public static final RiskAssessmentStatus REGISTERED = RiskAssessmentStatus.builder().value(Value.REGISTERED).build();
     ...
     */
    public static final RiskAssessmentStatus PRELIMINARY = RiskAssessmentStatus.builder().value(Value.PRELIMINARY).build();
     ...
     */
    public static final RiskAssessmentStatus FINAL = RiskAssessmentStatus.builder().value(Value.FINAL).build();
     ...
     * corrections.
     */
    public static final RiskAssessmentStatus AMENDED = RiskAssessmentStatus.builder().value(Value.AMENDED).build();
     ...
     */
    public static final RiskAssessmentStatus CORRECTED = RiskAssessmentStatus.builder().value(Value.CORRECTED).build();
     ...
     * "aborted").
     */
    public static final RiskAssessmentStatus CANCELLED = RiskAssessmentStatus.builder().value(Value.CANCELLED).build();
     ...
     */
    public static final RiskAssessmentStatus ENTERED_IN_ERROR = RiskAssessmentStatus.builder().value(Value.ENTERED_IN_ERROR).build();
     ...
     */
    public static final RiskAssessmentStatus UNKNOWN = RiskAssessmentStatus.builder().value(Value.UNKNOWN).build();
     ...
     */
    public static RiskAssessmentStatus of(Value value) {
        switch (value) {
        case REGISTERED:
            return REGISTERED;
        case PRELIMINARY:
    ...
    public static class Builder extends Code.Builder {
         ...
         * 
         * @param value
         *     An enum constant for RiskAssessmentStatus
         * 
         * @return
    ...
    public enum Value {
         ...
         *     A string that matches one of the allowed code values
         * @return
         *     The corresponding RiskAssessmentStatus.Value or null if a null value was passed
         * @throws IllegalArgumentException
