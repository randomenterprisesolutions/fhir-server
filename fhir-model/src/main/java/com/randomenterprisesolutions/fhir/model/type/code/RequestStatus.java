...
public class RequestStatus extends Code {
     ...
     */
    public static final RequestStatus DRAFT = RequestStatus.builder().value(Value.DRAFT).build();
     ...
     */
    public static final RequestStatus ACTIVE = RequestStatus.builder().value(Value.ACTIVE).build();
     ...
     * future.
     */
    public static final RequestStatus ON_HOLD = RequestStatus.builder().value(Value.ON_HOLD).build();
     ...
     */
    public static final RequestStatus REVOKED = RequestStatus.builder().value(Value.REVOKED).build();
     ...
     */
    public static final RequestStatus COMPLETED = RequestStatus.builder().value(Value.COMPLETED).build();
     ...
     */
    public static final RequestStatus ENTERED_IN_ERROR = RequestStatus.builder().value(Value.ENTERED_IN_ERROR).build();
     ...
     */
    public static final RequestStatus UNKNOWN = RequestStatus.builder().value(Value.UNKNOWN).build();
     ...
     */
    public static RequestStatus of(Value value) {
        switch (value) {
        case DRAFT:
            return DRAFT;
        case ACTIVE:
    ...
    public static class Builder extends Code.Builder {
         ...
         * 
         * @param value
         *     An enum constant for RequestStatus
         * 
         * @return
        ...
        protected void validate(RequestStatus requestStatus) {
            super.validate(requestStatus);
        }

        protected Builder from(RequestStatus requestStatus) {
            super.from(requestStatus);
            return this;
        }
    }
    ...
    public enum Value {
         ...
         *     A string that matches one of the allowed code values
         * @return
         *     The corresponding RequestStatus.Value or null if a null value was passed
         * @throws IllegalArgumentException
