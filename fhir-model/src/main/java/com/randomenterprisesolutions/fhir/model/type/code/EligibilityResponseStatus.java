...
public class EligibilityResponseStatus extends Code {
    /**
     * Active
     * 
    ...
    private EligibilityResponseStatus(Builder builder) {
        super(builder);
    }
    ...
    public boolean equals(Object obj) {
        ...
        EligibilityResponseStatus other = (EligibilityResponseStatus) obj;
    ...
    public enum Value {
         ...
         *     A string that matches one of the allowed code values
         * @return
         *     The corresponding EligibilityResponseStatus.Value or null if a null value was passed
         * @throws IllegalArgumentException
