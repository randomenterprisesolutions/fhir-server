...
public class PaymentNoticeStatus extends Code {
     ...
     */
    public static final PaymentNoticeStatus ACTIVE = PaymentNoticeStatus.builder().value(Value.ACTIVE).build();
     ...
     */
    public static final PaymentNoticeStatus CANCELLED = PaymentNoticeStatus.builder().value(Value.CANCELLED).build();
     ...
     */
    public static final PaymentNoticeStatus DRAFT = PaymentNoticeStatus.builder().value(Value.DRAFT).build();
     ...
     */
    public static final PaymentNoticeStatus ENTERED_IN_ERROR = PaymentNoticeStatus.builder().value(Value.ENTERED_IN_ERROR).build();
     ...
     */
    public static PaymentNoticeStatus of(Value value) {
        switch (value) {
        case ACTIVE:
            return ACTIVE;
        case CANCELLED:
    ...
    public boolean equals(Object obj) {
        ...
        PaymentNoticeStatus other = (PaymentNoticeStatus) obj;
    ...
    public static class Builder extends Code.Builder {
         ...
         * 
         * @param value
         *     An enum constant for PaymentNoticeStatus
         * 
         * @return
    ...
    public enum Value {
         ...
         *     A string that matches one of the allowed code values
         * @return
         *     The corresponding PaymentNoticeStatus.Value or null if a null value was passed
         * @throws IllegalArgumentException
