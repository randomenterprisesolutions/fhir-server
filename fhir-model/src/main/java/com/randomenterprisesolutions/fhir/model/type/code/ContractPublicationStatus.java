...
package com.randomenterprisesolutions.fhir.model.type.code;

import com.randomenterprisesolutions.fhir.model.annotation.System;
...
public class ContractPublicationStatus extends Code {
     ...
     */
    public static final ContractPublicationStatus AMENDED = ContractPublicationStatus.builder().value(Value.AMENDED).build();
     ...
     */
    public static final ContractPublicationStatus APPENDED = ContractPublicationStatus.builder().value(Value.APPENDED).build();
     ...
     * aborted.
     */
    public static final ContractPublicationStatus CANCELLED = ContractPublicationStatus.builder().value(Value.CANCELLED).build();
     ...
     */
    public static final ContractPublicationStatus DISPUTED = ContractPublicationStatus.builder().value(Value.DISPUTED).build();
     ...
     */
    public static final ContractPublicationStatus ENTERED_IN_ERROR = ContractPublicationStatus.builder().value(Value.ENTERED_IN_ERROR).build();
     ...
     */
    public static final ContractPublicationStatus EXECUTABLE = ContractPublicationStatus.builder().value(Value.EXECUTABLE).build();
     ...
     * completed.
     */
    public static final ContractPublicationStatus EXECUTED = ContractPublicationStatus.builder().value(Value.EXECUTED).build();
     ...
     */
    public static final ContractPublicationStatus NEGOTIABLE = ContractPublicationStatus.builder().value(Value.NEGOTIABLE).build();
     ...
     */
    public static final ContractPublicationStatus OFFERED = ContractPublicationStatus.builder().value(Value.OFFERED).build();
     ...
     * proposed; intended.
     */
    public static final ContractPublicationStatus POLICY = ContractPublicationStatus.builder().value(Value.POLICY).build();
     ...
     */
    public static final ContractPublicationStatus REJECTED = ContractPublicationStatus.builder().value(Value.REJECTED).build();
     ...
     * superseded.
     */
    public static final ContractPublicationStatus RENEWED = ContractPublicationStatus.builder().value(Value.RENEWED).build();
     ...
     */
    public static final ContractPublicationStatus REVOKED = ContractPublicationStatus.builder().value(Value.REVOKED).build();
     ...
     */
    public static final ContractPublicationStatus RESOLVED = ContractPublicationStatus.builder().value(Value.RESOLVED).build();
     ...
     */
    public static final ContractPublicationStatus TERMINATED = ContractPublicationStatus.builder().value(Value.TERMINATED).build();
     ...
     */
    public static ContractPublicationStatus of(Value value) {
        switch (value) {
        case AMENDED:
            return AMENDED;
        case APPENDED:
    ...
    public static class Builder extends Code.Builder {
         ...
         * 
         * @param value
         *     An enum constant for ContractPublicationStatus
         * 
         * @return
    ...
    public enum Value {
         ...
         *     A string that matches one of the allowed code values
         * @return
         *     The corresponding ContractPublicationStatus.Value or null if a null value was passed
         * @throws IllegalArgumentException
