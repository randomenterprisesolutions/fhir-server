...
public class CoverageStatus extends Code {
     ...
     */
    public static final CoverageStatus ACTIVE = CoverageStatus.builder().value(Value.ACTIVE).build();
     ...
     */
    public static final CoverageStatus CANCELLED = CoverageStatus.builder().value(Value.CANCELLED).build();
     ...
     */
    public static final CoverageStatus DRAFT = CoverageStatus.builder().value(Value.DRAFT).build();
     ...
     */
    public static final CoverageStatus ENTERED_IN_ERROR = CoverageStatus.builder().value(Value.ENTERED_IN_ERROR).build();
     ...
     */
    public static CoverageStatus of(Value value) {
        switch (value) {
        case ACTIVE:
            return ACTIVE;
        case CANCELLED:
    ...
    public static class Builder extends Code.Builder {
         ...
         * 
         * @param value
         *     An enum constant for CoverageStatus
         * 
         * @return
    ...
    public enum Value {
         ...
         *     A string that matches one of the allowed code values
         * @return
         *     The corresponding CoverageStatus.Value or null if a null value was passed
         * @throws IllegalArgumentException
