...
public class ClaimStatus extends Code {
     ...
     */
    public static final ClaimStatus ACTIVE = ClaimStatus.builder().value(Value.ACTIVE).build();
     ...
     */
    public static final ClaimStatus CANCELLED = ClaimStatus.builder().value(Value.CANCELLED).build();
     ...
     */
    public static final ClaimStatus DRAFT = ClaimStatus.builder().value(Value.DRAFT).build();
     ...
     */
    public static final ClaimStatus ENTERED_IN_ERROR = ClaimStatus.builder().value(Value.ENTERED_IN_ERROR).build();
     ...
     */
    public static ClaimStatus of(Value value) {
        switch (value) {
        case ACTIVE:
            return ACTIVE;
        case CANCELLED:
    ...
    public static class Builder extends Code.Builder {
         ...
         * 
         * @param value
         *     An enum constant for ClaimStatus
         * 
         * @return
    ...
    public enum Value {
         ...
         *     A string that matches one of the allowed code values
         * @return
         *     The corresponding ClaimStatus.Value or null if a null value was passed
         * @throws IllegalArgumentException
