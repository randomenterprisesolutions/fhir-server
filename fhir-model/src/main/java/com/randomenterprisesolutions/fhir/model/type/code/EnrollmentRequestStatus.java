...
public class EnrollmentRequestStatus extends Code {
     ...
     */
    public static final EnrollmentRequestStatus ACTIVE = EnrollmentRequestStatus.builder().value(Value.ACTIVE).build();
     ...
     */
    public static final EnrollmentRequestStatus CANCELLED = EnrollmentRequestStatus.builder().value(Value.CANCELLED).build();
     ...
     */
    public static final EnrollmentRequestStatus DRAFT = EnrollmentRequestStatus.builder().value(Value.DRAFT).build();
     ...
     */
    public static final EnrollmentRequestStatus ENTERED_IN_ERROR = EnrollmentRequestStatus.builder().value(Value.ENTERED_IN_ERROR).build();
     ...
     */
    public static EnrollmentRequestStatus of(Value value) {
        switch (value) {
        case ACTIVE:
            return ACTIVE;
        case CANCELLED:
    ...
    public static class Builder extends Code.Builder {
         ...
         * 
         * @param value
         *     An enum constant for EnrollmentRequestStatus
         * 
         * @return
    ...
    public enum Value {
         ...
         *     A string that matches one of the allowed code values
         * @return
         *     The corresponding EnrollmentRequestStatus.Value or null if a null value was passed
         * @throws IllegalArgumentException
