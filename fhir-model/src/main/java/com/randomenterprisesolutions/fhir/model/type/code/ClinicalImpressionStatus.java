...
public class ClinicalImpressionStatus extends Code {
    ...
    private ClinicalImpressionStatus(Builder builder) {
        super(builder);
    }
    ...
    public boolean equals(Object obj) {
        ...
        ClinicalImpressionStatus other = (ClinicalImpressionStatus) obj;
    ...
    public enum Value {
         ...
         *     A string that matches one of the allowed code values
         * @return
         *     The corresponding ClinicalImpressionStatus.Value or null if a null value was passed
         * @throws IllegalArgumentException
