package com.randomenterprisesolutions.fhir.model.string.util.test;
...
import com.randomenterprisesolutions.fhir.model.string.util.StringSizeControlStrategyFactory;
import com.randomenterprisesolutions.fhir.model.string.util.StringSizeControlStrategyFactory.Strategy;
import com.randomenterprisesolutions.fhir.model.string.util.strategy.MaxBytesStringSizeControlStrategy;
...
public class StringSizeControlStrategyTest {
    ...
    public void testStringSizeControlStrategyFactory() throws FHIROperationException {
        ...
        com.randomenterprisesolutions.fhir.model.string.util.strategy.StringSizeControlStrategy strategy = factory.getStrategy(Strategy.MAX_BYTES);
    ...
    public void testStringSizeControlStrategy_WithInpExceedingSizeLimit() throws FHIROperationException {
        ...
        assertTrue(truncatedDescription.getBytes(StandardCharsets.UTF_8).length == MAX_SEARCH_STRING_BYTES);
    }
    ...
    public void testStringSizeControlStrategy_WithInpEqSizeLimit() throws FHIROperationException {
        ...
        assertTrue(truncatedDescription.getBytes(StandardCharsets.UTF_8).length == maxBytes);
        assertTrue(truncatedDescription.getBytes(StandardCharsets.UTF_8).length == description.getBytes(StandardCharsets.UTF_8).length);
    }
    ...
    public void testStringSizeControlStrategy_WithUnicodeInpExceedingSizeLimit() throws FHIROperationException {
        ...
        assertFalse(truncatedDescription.equals(description));
        assertTrue(truncatedDescription.getBytes(StandardCharsets.UTF_8).length <= maxBytes);
        assertFalse(truncatedDescription.getBytes(StandardCharsets.UTF_8).length == description.getBytes(StandardCharsets.UTF_8).length);
    }
