...
public class ModelBuilderTest {
    ...
    public void testPrimitiveSetterEquivalence() {
        ...
        Patient p2 = Patient.builder()
                .meta(Meta.builder()
                    .lastUpdated(com.randomenterprisesolutions.fhir.model.type.Instant.of("2021-08-19T00:59:59-05:00"))       // Instant
                    .build())
                .extension(Extension.builder()
                    .url("test")
                    .value(string("string"))
                ...
                .contained(ValueSet.builder()
                    ...
                    .expansion(Expansion.builder()
                        .timestamp(DateTime.of("2021-08-19T00:59:59-05:00"))
                        .total(com.randomenterprisesolutions.fhir.model.type.Integer.of(0))                                   // Integer
                        .build())
                    .build())
                .active(com.randomenterprisesolutions.fhir.model.type.Boolean.FALSE)                                          // Boolean
                .birthDate(com.randomenterprisesolutions.fhir.model.type.Date.of("1984-09-04"))                               // Date
                .multipleBirth(com.randomenterprisesolutions.fhir.model.type.Integer.of(1))
                .name(HumanName.builder()
