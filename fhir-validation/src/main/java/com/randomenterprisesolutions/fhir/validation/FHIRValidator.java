...
package com.randomenterprisesolutions.fhir.validation;
...
import static com.randomenterprisesolutions.fhir.path.util.FHIRPathUtil.getResourceNode;
import static com.randomenterprisesolutions.fhir.path.util.FHIRPathUtil.getRootResourceNode;
...
import static com.randomenterprisesolutions.fhir.validation.util.FHIRValidationUtil.ISSUE_COMPARATOR;
import static com.randomenterprisesolutions.fhir.validation.util.FHIRValidationUtil.hasErrors;
...
import com.randomenterprisesolutions.fhir.model.annotation.Constraint.FHIRPathConstraintValidator;
import com.randomenterprisesolutions.fhir.model.constraint.spi.ConstraintValidator;
...
import com.randomenterprisesolutions.fhir.model.visitor.PathAwareCollectingVisitor;
...
import com.randomenterprisesolutions.fhir.path.util.DiagnosticsEvaluationListener;
...
/**
 * A validator that uses conformance resources from the {@link com.randomenterprisesolutions.fhir.registry.FHIRRegistry}
