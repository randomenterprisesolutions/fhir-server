...
public class PatientTest {
    ...
    public void testUnknownExtensions() {
        com.randomenterprisesolutions.fhir.model.type.String given = com.randomenterprisesolutions.fhir.model.type.String.builder()
                .value("John")
                .extension(Extension.builder()
                    ...
                    .build())
                .build();
        com.randomenterprisesolutions.fhir.model.type.String otherGiven = com.randomenterprisesolutions.fhir.model.type.String.builder()
                .extension(Extension.builder()
                    .url("http://example.com/someExtension")
    ...
    public void testWarningFromExtensibleBindingOnSubField() {
        ...
        Contact contact = Contact.builder()
                .name(HumanName.builder()
                    .text(com.randomenterprisesolutions.fhir.model.type.String.of("Name"))
                    .build())
