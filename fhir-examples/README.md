...
* `com.randomenterprisesolutions.fhir.examples.Index` is an enum that mirrors the ".txt" files found at `src/main/resources`
* `com.randomenterprisesolutions.fhir.examples.ExamplesUtil` has static helpers for obtaining a FileReader for both the index file and the example resources themselves
