...
package com.randomenterprisesolutions.fhir.provider;

import static com.randomenterprisesolutions.fhir.model.util.FHIRUtil.buildOperationOutcome;
import static com.randomenterprisesolutions.fhir.model.util.FHIRUtil.buildOperationOutcomeIssue;
import static com.randomenterprisesolutions.fhir.model.util.JsonSupport.nonClosingInputStream;
import static com.randomenterprisesolutions.fhir.model.util.JsonSupport.nonClosingOutputStream;
import static com.randomenterprisesolutions.fhir.provider.util.FHIRProviderUtil.buildResponse;
import static com.randomenterprisesolutions.fhir.provider.util.FHIRProviderUtil.getMediaType;
