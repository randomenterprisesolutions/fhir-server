...
package com.randomenterprisesolutions.fhir.database.utils.transaction;
...
public final class SimpleTransaction implements ITransaction {
    ...
    /* (non-Javadoc)
     * @see com.randomenterprisesolutions.fhir.database.utils.api.ITransaction#setRollbackOnly()
     */
    @Override
