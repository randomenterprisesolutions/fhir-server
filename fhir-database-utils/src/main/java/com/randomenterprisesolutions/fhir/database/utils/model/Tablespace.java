...
package com.randomenterprisesolutions.fhir.database.utils.model;
...
public class Tablespace extends DatabaseObject {
    ...
    /* (non-Javadoc)
     * @see com.randomenterprisesolutions.fhir.database.utils.model.IDatabaseObject#visit(com.randomenterprisesolutions.fhir.database.utils.model.DataModelVisitor)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.randomenterprisesolutions.fhir.database.utils.model.IDatabaseObject#visitReverse(com.randomenterprisesolutions.fhir.database.utils.model.DataModelVisitor)
     */
    @Override
