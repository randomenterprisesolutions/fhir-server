...
public class UpdateOperation extends BaseOperation {
     ...
     */
    private <T extends Resource> T copyAndSetResourceMetaFields(T resource, String logicalId, int newVersionNumber, com.randomenterprisesolutions.fhir.model.type.Instant lastUpdated) {
