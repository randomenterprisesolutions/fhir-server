...
package com.randomenterprisesolutions.fhir.persistence.jdbc.test.connection;
...
public class FHIRUserTransactionAdapterTest {
    ...
    public void testStandardFlow() throws Exception {
        ...
        FHIRUserTransactionAdapter adapter = new FHIRUserTransactionAdapter(tx, sync, null, null, null);
    ...
    public void sharedNestedRollback() throws Exception {
        ...
        FHIRUserTransactionAdapter nested = new FHIRUserTransactionAdapter(tx, sync, null, null, null);
        nested.begin();
        assertEquals(tx.getStatus(), Status.STATUS_ACTIVE);
