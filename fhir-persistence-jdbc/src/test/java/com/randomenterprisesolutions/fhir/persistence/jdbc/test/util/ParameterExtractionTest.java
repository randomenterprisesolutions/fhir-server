...
package com.randomenterprisesolutions.fhir.persistence.jdbc.test.util;
...
public class ParameterExtractionTest {
    ...
    public void testBoolean() throws FHIRPersistenceProcessorException {
        ...
        com.randomenterprisesolutions.fhir.model.type.Boolean.TRUE.accept(parameterBuilder);
        ...
        assertNullValueReturnsNoParameters(tokenSearchParam, com.randomenterprisesolutions.fhir.model.type.Boolean.builder());
    }
    ...
    public void testString() throws FHIRPersistenceProcessorException {
        JDBCParameterBuildingVisitor parameterBuilder;
        com.randomenterprisesolutions.fhir.model.type.String stringVal = string(SAMPLE_STRING);
        List<ExtractedParameterValue> params;
    ...
    public void testString_null() throws FHIRPersistenceProcessorException {
        assertNullValueReturnsNoParameters(stringSearchParam, com.randomenterprisesolutions.fhir.model.type.String.builder());
        assertNullValueReturnsNoParameters(tokenSearchParam, com.randomenterprisesolutions.fhir.model.type.String.builder());
    }
