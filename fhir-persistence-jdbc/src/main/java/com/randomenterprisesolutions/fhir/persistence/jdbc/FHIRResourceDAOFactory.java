...
import com.randomenterprisesolutions.fhir.database.utils.common.DatabaseTranslatorFactory;
...
import com.randomenterprisesolutions.fhir.persistence.jdbc.citus.CitusResourceDAO;
...
import com.randomenterprisesolutions.fhir.persistence.jdbc.dao.api.FhirSequenceDAO;
...
import com.randomenterprisesolutions.fhir.persistence.jdbc.derby.DerbyCommonValuesDAO;
import com.randomenterprisesolutions.fhir.persistence.jdbc.derby.DerbyResourceDAO;
import com.randomenterprisesolutions.fhir.persistence.jdbc.impl.ParameterTransactionDataImpl;
import com.randomenterprisesolutions.fhir.persistence.jdbc.postgres.PostgresReindexResourceDAO;
...
public class FHIRResourceDAOFactory {
    ...
    public static FhirSequenceDAO getSequenceDAO(Connection connection, FHIRDbFlavor flavor) {
        ...
        switch (flavor.getType()) {
        case DERBY:
            result = new com.randomenterprisesolutions.fhir.persistence.jdbc.derby.FhirSequenceDAOImpl(connection);
            break;
        case POSTGRESQL:
        case CITUS:
            result = new com.randomenterprisesolutions.fhir.persistence.jdbc.postgres.FhirSequenceDAOImpl(connection);
            break;
        default:
            throw new IllegalArgumentException("Unsupported database type: " + flavor.getType().name());
        }
