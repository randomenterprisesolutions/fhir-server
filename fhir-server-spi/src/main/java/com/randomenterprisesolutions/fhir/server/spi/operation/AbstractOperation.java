                    ...
                    if (inputParameter.getPart() == null || inputParameter.getPart().isEmpty()) {
                        ...
                        try {
                            ...
                            if (ModelSupport.isResourceType(parameterDefinitionTypeName)) {
                                parameterDefinitionType = Class.forName("com.randomenterprisesolutions.fhir.model.resource." + parameterDefinitionTypeName);
                            } else {
                                parameterDefinitionType = Class.forName("com.randomenterprisesolutions.fhir.model.type." + parameterDefinitionTypeName);
                            }
