...
package com.randomenterprisesolutions.fhir.benchmark.runner;
...
public class FHIRBenchmarkRunner {
    public static final String PROPERTY_EXAMPLE_NAME = "com.randomenterprisesolutions.fhir.benchmark.exampleName";
    public static final String PROPERTY_EXPRESSION = "com.randomenterprisesolutions.fhir.benchmark.expression";
